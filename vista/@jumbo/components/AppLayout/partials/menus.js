...
const dashboardsMenus = [
  ...
  {
    name: <IntlMessages id={'Leads'} />,
    icon: <MonetizationOn />,
    type: 'item',
    link: '/dashboard/leads',
  },
  {
    name: <IntlMessages id={'Developers'} />,
    icon: <Domain />,
    type: 'item',
  ...
  {
    name: <IntlMessages id={`Business-Developers`} />,
    icon: <DonutSmall />,
    type: 'item',
    link: '/dashboard/Business-Developers',
  },
  {
    name: <IntlMessages id={'Permissions'} />,
